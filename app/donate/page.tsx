...
import { ArrowLeft, Building2, Heart, Package } from 'lucide-react'
...
export default function DonatePage() {
  ...
  const donationsEmail = 'hello@privilegegirlsfoundation.org'
      ...
      <main className="pt-24 pb-20 px-6">
        ...
        <div className="mx-auto mt-16 max-w-xl rounded-3xl border border-border/70 bg-secondary/40 p-8 md:p-10">
          ...
          <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
            Share your name and how you&apos;d like to support — we&apos;ll respond with next steps and
            (where relevant) bank or mobile-money details.
          </p>
          <form
            ...
            onSubmit={(e) => {
              ...
              const subject = encodeURIComponent('PGF — Support / donation enquiry')
              const body = encodeURIComponent(
                `Name: ${data.get('name')}\nEmail: ${data.get('email')}\nPhone: ${data.get('phone')}\n\nMessage:\n${data.get('message')}`,
              )
              window.location.href = `mailto:${donationsEmail}?subject=${subject}&body=${body}`
            }}
          >
            ...
            <p className="text-xs text-muted-foreground">
              Opens your email app to send your enquiry to our team.
            </p>
          </form>
        </div>
      </main>
